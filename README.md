...
(Need improvments / Potential CycleGAN)
...
Most other settings live in config.py.
...
Hit /latest (I made a Shortcut to get it on my iphone)

Download the ZIP

Assign icons in Shortcuts
...
save manifest so Im only creating Icons for new apps

Support multiple themes

Smarter logo/background separation (attempt to create a cycleGAN model)
